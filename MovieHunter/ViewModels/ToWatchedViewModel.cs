...
{
    public class ToWatchedViewModel : ViewModelBase
    {
        ...
        private void OnItemClick(SampleOrder clickedItem)
        {
            if (clickedItem != null)
            {
                ...
                NavigationService.Navigate(typeof(ToWatchedDetailViewModel).FullName, clickedItem.OrderId);
            }
        }
    }
}
